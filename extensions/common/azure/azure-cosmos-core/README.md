...
e.g. `asset-index-store-cosmos` or `policy-definition-store-cosmos`. Those submodules should contain the implementation for the
...
- [AssetIndex](../../../control-plane/store/cosmos/asset-index-store-cosmos/README.md)
