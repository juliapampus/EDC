...
include(":extensions:control-plane:api:data-management-api:contractagreement-api")
include(":extensions:control-plane:api:data-management-api:contractdefinition-api")
include(":extensions:control-plane:api:data-management-api:contractnegotiation-api")
include(":extensions:control-plane:api:data-management-api:policydefinition-api")
include(":extensions:control-plane:api:data-management-api:transferprocess-api")
...
include(":extensions:control-plane:store:cosmos:asset-index-store-cosmos")
...
include(":extensions:control-plane:store:cosmos:control-plane-store-cosmos")
...
include(":extensions:control-plane:store:sql:asset-index-store-sql")
...
include(":extensions:control-plane:store:sql:control-plane-store-sql")
